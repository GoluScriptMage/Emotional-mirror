 ...
 * @param {string} calculatorType - Type of calculator (heartReality, bondInsight, workPsyche, innerEcho)
 * @param {string} userName - User's name
 * @param {string} targetGender - Gender preference (for heartReality calculator only)
